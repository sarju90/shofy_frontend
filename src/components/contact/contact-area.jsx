                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:dharsandiyasarju.it@gmail.com">dharsandiyasarju.it@gmail.com</a>
                      </p>
                      <p data-info="phone">
                        <a href="tel:9016161800">+91 90161 61800</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p>
                        <a
                          href="https://g.co/kgs/BTjgHW1"
                          target="_blank"
                        >
                          Lorem ipsum dolor sit amet. <br />51432
                        </a>
                      </p>
                    </div>
                  </div>
